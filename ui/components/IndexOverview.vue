...
<template>
  ...
  <div class="col-12 lg:col-6 xl:col-4">
    <div class="card mb-0">
      ...
      <div class="text-500 font-medium mt-1 flex gap-3">
        <LinkMultiple href="https://waha.devlike.pro/docs/overview/changelog/">
          {{ t('dashboard.changelog') }}
        </LinkMultiple>
        <LinkMultiple href="https://waha.devlike.pro/blog/waha-update/">
          {{ t('dashboard.howToUpdate') }}
        </LinkMultiple>
      </div>
